<template>
    <div class="scheme-box">
        <div class="scheme">
           ...
           <h2 class="two-h">{{scheme.TITLE_TWO}}</h2>
           ...
           <div v-for="(item,index) in scheme.THREE_ONE_LIST" :key="index">
            ...
            <p class="content">
                {{scheme.THREE_TWO_P1}}
                <a class="scheme-a" target="_Blank" href="https://www.openeuler.org/zh/compatibility/hardware/">{{scheme.THREE_TWO_A1}}</a>
                {{scheme.THREE_TWO_P2}}
                <a class="scheme-a" target="_Blank" href="https://www.openeuler.org/zh/compatibility/">{{scheme.THREE_TWO_A2}}</a>
            </p>
            <h3 class="three-h">{{scheme.TITLE_THREE_THREE}}</h3>
            <p class="content">
                 {{scheme.THREE_THREE_P1}}
                <a class="scheme-a" target="_Blank" href="https://gitee.com/openeuler/oec-application/blob/master/doc/openEuler%E7%A4%BE%E5%8C%BA%E5%BC%80%E6%BA%90%E8%BD%AF%E4%BB%B6%E9%80%82%E9%85%8D%E6%B5%81%E7%A8%8B.md">{{scheme.THREE_THREE_A1}}</a>
                {{scheme.THREE_THREE_P2}}
                <a class="scheme-a" target="_Blank" href="https://www.openeuler.org/zh/compatibility/">{{scheme.THREE_THREE_A2}}</a>
            </p>
            <h3 class="three-h">{{scheme.TITLE_THREE_FOUR}}</h3>
            <p class="content">
                {{scheme.THREE_FOUR_P1}}
                <a class="scheme-a" target="_Blank" href="https://gitee.com/openeuler/oecp">{{scheme.THREE_FOUR_A1}}</a>
                {{scheme.THREE_FOUR_P2}}
            </p>
            <h2 class="two-h">{{scheme.TITLE_FOUR}}</h2>
            <h3 class="three-h">{{scheme.TITLE_FOUR_ONE}}</h3>
            <p class="content">
                 {{scheme.FOUR_ONE_P1}}
                <a class="scheme-a" target="_Blank" href="https://repo.oepkgs.net/openEuler/rpm/openEuler-20.03-LTS-SP1/extras-tgz/noarch/x2openEuler.tar.gz">{{scheme.FOUR_ONE_A1}}</a>
                {{scheme.FOUR_ONE_P2}}
            </p>
            ...
            <h2 class="two-h">{{scheme.TITLE_FIVE}}</h2>
            ...
            <p class="content">
                ...
                <a class="scheme-a" target="_Blank" href="https://www.openeuler.org/zh/compatibility/hardware/">{{scheme.FIVE_THREE_A1}}</a>
            ...
            <h2 class="two-h">{{scheme.TITLE_SIX}}</h2>
            ...
            <h2 class="two-h">{{scheme.TITLE_SEVNE}}</h2>
