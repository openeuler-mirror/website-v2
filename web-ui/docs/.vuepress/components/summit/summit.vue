...
<template>
  <div class="summit">
    <common-banner
      :pc-src="'/img/summit/summit-banner.svg'"
      :mobile-src="'/img/summit/summit-banner.svg'"
      :inside-name="'CONNECT'"
      :outside-name="isSummitHome?i18n.interaction.SUMMIT.SUMMIT:i18n.interaction.SUMMIT.LISTTITLE"
    >
...
.summit {
  ...
  .review {
    ...
    .review-list {
      display: inline-block;
      .word-common-css(30px,PingFangSC-Regular,PingFang SC,400,rgba(0,0,0,1),30px);
      .mr(top,262px);
      @media (max-width: 1000px) {
        .word-common-css(16px,FZLTHJW--GB1-0,FZLTHJW--GB1,normal,rgba(0,47,167,1),26px);
        .mr-All(20px 0 21px 88px);
      }
    }
    .list-time {
      @media (max-width: 1000px) {
