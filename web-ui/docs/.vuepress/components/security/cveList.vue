  ...
  <div class="cve-list-content">
    ...
    <div class="cve-list-wrapper">
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="cveId" label="CVE" width="211">
      ...
      <ul class="mobile-list" v-loading.fullscreen="tableLoading">
        <li class="item" v-for="(item, index) in tableData" :key="index">
          <ul>
            <li>
              <span>CVE:</span>
              <a class="table-link" @click="go(item.cveId)">{{item.cveId}}</a>
            </li>
            <li>
            ...
            <li>
              ...
              <a class="table-link" @click="go(item.cveId)">{{i18n.security.DETAIL}}</a>
            </li>
          </ul>
        </li>
      </ul>
