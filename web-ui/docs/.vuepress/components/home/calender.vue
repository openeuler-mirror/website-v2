    ...
    <div class="calender is-pc">
        <div class="calendar-top">
            ...
            <div class="calenderSliderTopMain">
                <div class="calenderSliderTopMainswiper" :style="'width:' + (tableData.length * 260) + 'px;transform:translateX(' + l + 'px)'">
                    <span v-for="(item,key) in dealData" :key="key" :class="{ active: item.date == currentDate }">{{ item.date }}</span>
                </div>
            </div>
        </div>
        <div class="calenderMain">
            <div class="calenderLeft">
                <button class="top" @click="handleBtn('top')" :style="{ background: 'url(' + prev + ') no-repeat center' }"></button>
                <button class="bottom" @click="handleBtn('bottom')" :style="{ background: 'url(' + prev + ') no-repeat center' }"></button>
                <div class="calenderLeftTime">
                    <div class="calendarLeftTimeSwiper" :style="'width: ' + (tableData.length * 260) + 'px;transform: translateY(' + t + 'px)'">
                        <span v-for="(item, key) in timeData" :key="key" :class="{ active: item == currentTime }">{{ item }}</span>
                    </div>
                </div>
            </div>
            <div class="calendarSlide">
                ...
                <div class="calendarSlideItem" :style="'transform: translateX(' + l + 'px)'">
                    <template v-for="(item, key) in dealData">
                        <div class="calenderslideItemInside" :key="key" :style="'transform: translateY(' + (item.timeDate.length == 1 && item.timeDate[0].duration >= 16 ? 0: t) + 'px)'">
                                        ...
                                        <div :key="index2" class="calenderListSinge" :style="returnInsideH(item2)" v-if="item1.duration < 16">
                                            ...
                                            <div class="calenderInsideAll" :style="'transform: translateX(' + (-240 * (item2.index - 1)) + 'px)'">
                                                <div v-for="(item3, index3) in item2.data" :key="index3"
                                                    ...
                                                    <div class="meetDetail" v-if="item1.duration > 1 && item3.duration == item1.duration">
    ...
    export default {
        ...
        methods: {
            ...
            returnDate(string){
                ...
                let nowTime=y+"-"+this.toTwo(M)+"-"+this.toTwo(d)+" "+this.toTwo(h)+":"+this.toTwo(m)+this.toTwo(s);
                if(string === "dateTime"){
                    return currentDate;
