...
export const softwareList = ({
    ...
    return new Promise((resolve, reject) => {
        ...
        appAjax.postJson({
            url: `https://api-proxy.openeuler.isrc.ac.cn/web_backend/compat_software_info?page_size=10&page_num=${page}${type}${architecture}${os}${keyword}`,
            type: 'get',
...
export const softwareOptions = () => {
    return new Promise((resolve, reject) => {
        appAjax.postJson({
            url: 'https://api-proxy.openeuler.isrc.ac.cn/web_backend/query_compat_software',
            type: 'get',
            notAuthorization:true,
            success(result) {
                if (result) {
