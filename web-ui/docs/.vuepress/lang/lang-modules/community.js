    ...
    cn: {
        ...
        CONTRIBUTION: {
            ...
            LINK_LIST: [
                ...
                '/zh/interaction/summit-list/summit2021/',
                '/zh/sig/sig-list/',
                '/zh/sig/sig-guidance/',
    ...
    en: {
        ...
        CONTRIBUTION: {
            ...
            LINK_LIST: [
                ...
                '/en/interaction/summit-list/summit2021/',
                '/en/sig/sig-list/',
                '/en/sig/sig-guidance/',
                'https://gitee.com/openeuler/community/issues',
                '/en/community/contribution/detail.html#_2-贡献编码',
                '/en/community/contribution/detail.html#_3-贡献软件包',
    ...
    ru: {
        ...
        CONTRIBUTION: {
            ...
            LINK_LIST: [
                ...
                '/ru/interaction/summit-list/summit2021/',
                '/ru/sig/sig-list/',
                '/ru/sig/sig-guidance/',
                'https://gitee.com/openeuler/community/issues',
