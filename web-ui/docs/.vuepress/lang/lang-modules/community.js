    ...
    cn: {
        ...
        CONTRIBUTION: {
            ...
            LINK_LIST: [
                ...
                '/interaction/salon-list',
                '/interaction/live-list/',
                '/interaction/summit-list/',
                '/sig/sig-list/',
                '/sig/sig-guidance/',
                'https://gitee.com/openeuler/community/issues',
                '/community/contribution/detail.html#_2-贡献编码',
                '/community/contribution/detail.html#_4-贡献原创开源项目',
                ...
                '/sig/sig-list/sig-detail.html?id=21&name=TC&mail=dev%40openeuler.org'
            ]
        },
        CONDUCT: {
            TITLE: "行为守则"
