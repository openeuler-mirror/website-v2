        ...
        SCHEME:{
            ...
            THREE_ONE_LIST:[
                ...
                ['芯片兼容性：包括CPU芯片架构(X86/ARM/alpha/龙芯)，基于芯片架构，衍生不同CPU厂家，如：intel、海光、兆芯，AMD，鲲鹏、飞腾、申威、龙芯；部件芯片(网卡/raid/fc/ib/gpu/ssd/tpm)等。',
                 ...
                 {title: '（5）OSV兼容性',content: ['欧拉产品与二次发行商生态复用检测能力，主要是任何一个OSV厂家与软件、硬件一次适配，可以在多个OS 间可以复用，可以有效避免每个OSV在相同软件上的重复投入。']},
            ],
            ...
            THREE_ONE_P3: '支撑企业用户、开发者、合作伙伴基于社区服务按需适配软、硬件，共同共同打造欧拉系丰富的兼容性；',
            ...
            TITLE_SEVNE: '迁移调优',
            SEVEN_P1:'除了保障迁移后取得更好的性能，欧拉社区提供调优工具，A-Tune是一款基于AI开发的系统性能优化引擎，它利用人工智能技术，对业务场景建立精准的系统画像，感知并推理出业务特征，进而做出智能决策，匹配并推荐最佳的系统参数配置组合，使业务处于最佳运行状态。',
