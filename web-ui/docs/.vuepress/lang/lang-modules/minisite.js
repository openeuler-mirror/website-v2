...
module.exports = {
    cn: {
        ...
        MIGRATION_DESC: ['数字技术日益融入经济社会发展的各个领域和全过程，数字基础设施要面向IT、CT及OT等多种场景，要实现工业互联乃至万物智联，只有建立起强大的技术软件体系，才能够满足数字经济发展的需要；万物互联驱动算力多样性算力(CPU/GPU/XPU等)发展,促使使操作系统进行架构创新；同时随着企业产品持续创新、硬件算力的更新换代、操作系统版本生命周期，操作系统迁移的工作将成为常态；由于操作系统本身的差异带来软件、硬件、配置兼容性问题，影响了操作系统迁移。面向数字化转型过程中，企业一方面需要做好操作系统(如：全场景支持、持续演进、可靠、稳定方面等)选型，支撑企业产品创新、数字化转型；另一方面需要有系统性的迁移方案及工具，保障迁移无忧'],
        MIGRATION_LISTCONTENT:[
                ...
                {
                    SUBTITLE: 'openEuler面向数字基础设施的操作系统',
                    LISTTITLE: 'openEuler 是面向的数字基础设施开源操作系统',
                    CONTENT: [
                        '欧拉开源操作系统是面向数字基础设施的开源操作系统，支持服务器、云计算、边缘计算、嵌入式等应用场景，支持多样性计算，致力于提供安全、稳定、易用的操作系统。'
                    ],
                },
                {
