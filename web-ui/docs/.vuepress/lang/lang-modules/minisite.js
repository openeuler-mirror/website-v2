...
module.exports = {
    cn: {
        ...
        MIGRATION_DESC: ['随着数字化转型深入，操作系统正在向支持多样性计算、支持全场景的方向发展，在进行操作系统升级时，企业面临以下挑战：硬件兼容性、软件兼容性、升级后系统环境如何快速恢复？升级后如何能够更好发挥系统性能？openEuler作为一款面向数字基础设施的开源操作系统，最优支持多样性计算，满足服务器、云、边缘和嵌入式全场景。针对企业在升级操作系统时的需求，推出这份升级指南，助力企业简单、平稳、高效进行操作系统升级。'],
        MIGRATION_LISTCONTENT:[
                {
                    SUBTITLE: '数字化转型带来的操作系统变化及迁移诉求',
                    CONTENT: [
                        '数字技术日益融入经济社会发展的各个领域和全过程，数字基础设施要面向IT、CT及OT等多种场景，要实现工业互联乃至万物智联，只有建立起强大的技术软件体系，才能够满足数字经济发展的需要；万物互联驱动多样性算力(CPU/GPU/XPU等)发展,促使操作系统进行架构创新；同时随着企业产品持续创新、硬件算力的更新换代、操作系统版本生命周期演进，操作系统迁移的工作将成为常态；由于操作系统本身的差异带来软件、硬件、配置兼容性问题，影响了操作系统迁移进程。\n\n',
                ...
                },
                {
                    ...
                    CONTENT:[
                             'openEuler原生开源，独立演进，从三个层次实现持续发展，助力企业数字化转型。内核创新：在多核调度、多样性算力，以内存为中心新架构的支持等方面进行创新，自 2012 年以来向 Linux Kernel 社区持续贡献，在 Linux Kernel 5.10/5.14版本中，内核代码贡献排名第一。核心模块：为用户提供“双平面”运行选择，通过原创 stratoVirt 提供类qemu虚拟化能力，通过原创iSulad 提供类docker容器能力。全功能级：做到独立软件包选型，CVE漏洞管理，bug快速修复 ,主要特性介绍如下：',
                             '1. 性能最优：通过千核调度、内核热升级、NUMA aware、免锁优化、PB级内存扩展等独特内核创新技术，软硬协同优化，最佳支持多样性算力，性能相比于主流OS提升5%~20%。',
        ...
        DIRECT_CONTENT: '社区版本相关迁移问题， 请在兼容性 SIG 提交相关问题跟进。',
        DIRECT_URL: `https://gitee.com/openeuler/oec-application/issues`,
