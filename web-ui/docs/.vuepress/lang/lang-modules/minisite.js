...
module.exports = {
    cn: {
        ...
        MIGRATION_DESC: ['当前 linux 发行版厂家众多，且随着OS厂家版本演进，由于操作系统本身的差异带来软件、硬件、配置兼容性问题，严重阻碍了软件在各个操作系统中切换及升级，一旦客户生产环境的操作系统版本停服，如: CentOS 停服，给使用CentOS及其衍生版本的企业生产带来严重影响。面对上述风险，企业需要从持续演进、稳定、可靠等方面选择新操作系统，彻底解决安全运行问题；同时需要考虑生态完备性，行业应用成熟度，系统性的迁移工具，做到迁移无忧。'],
