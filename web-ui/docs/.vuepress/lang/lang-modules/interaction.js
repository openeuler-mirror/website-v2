...
module.exports = {
    cn: {
        ...
        SUMMIT: {
            SUMMIT: '峰会',
            SUMMITCONTENT:[
                'openEuler Summit 是由 openEuler 社区举办的开发者交流会，聚焦于软件开发的上下游，连接行业生态，为开发者提供一个开放、平等、包容的交流平台。今年，openEuler Summit 将于12月在北京举行。',
                'openEuler 不仅是一个支持多种处理器架构的操作系统，更是一个最具活力的开源社区。openEuler 代表了一种可能性，一种开源、开放模式下的蓬勃朝气，一种从无到有、从0到1的创造，一个可以燎原的火种。在这里，没有厂商绑定，没有严苛规则，只看代码实力、项目创意，通过社区合作，持续孵化开源项目，推动云原生技术的发展。',
                '每一位开发者都是这个时代宝贵的财富，我们非常高兴你能够分享 openEuler 社区中的最新成果，你的分享将会鼓励开发者去建设最有活力的开源社区。这是一个开源创新的时代，更是每一个开发者的时代。'
            ],
            HOMETITLE: '精彩回顾',
            LISTTITLE: '精彩回顾',
            LISTNEWTITLE: 'openEuler 峰会 2020',
            SUMMITTIP: '报名通道现已正式开启，期待您的分享。',
            LISTTIME: '2020年4月17-18日',
            SPEECHTITLE: '主题演讲',
            DESIGNTITLE: '设计峰会（项目组专题研讨）',
            VIDEODOWNLOAD: '附件下载',
            FRIENDSHIPLINK: '友情链接',
            SPEAKER_TEXT: 'Call for Speaker',
            SPONSOR_TEXT: 'Call for Sponsor',
            SPEAKER_IMG: '/img/summit/speaker.png',
            SPONSOR_IMG: '/img/summit/sponsor.png',
    ...
    en: {
        ...
        SUMMIT: {
            SUMMIT: 'Summit',
            SUMMITCONTENT: [
                'The openEuler Summit is a developer exchange meeting held by the openEuler community. It focuses on the upstream and downstream of software development, connects the industry ecology, and provides an open, equal and inclusive communication platform for developers. This year, the openEuler Summit will be held in Beijing in December. ',
                'openEuler is not only an operating system that supports multiple processor architectures, but also one of the most dynamic open source communities. openEuler represents a kind of possibility, a kind of vigor under the open source and open mode, a kind of creation from nothing, from 0 to 1, a kind of fire that can start a prairie fire. There is no vendor binding, no strict rules, only code strength, project creativity. openEuler continues to incubate open source projects through community collaboration to promote the development of cloud native technologies. ',
                'Every developer is a valuable asset in this era, we are pleased to share with you the latest achievements of the openEuler community and encourage developers to build the most dynamic open source community. This is an era of open source innovation, but also the era of every developer. '
            ],
            HOMETITLE: 'Wonderful Review',
            LISTTITLE: 'Overview',
            LISTNEWTITLE:'openEuler Virtual Summit 2020',
            SUMMITTIP: 'The registration channel is now open. We are looking forward to your participation.',
